...
summary:    这篇文章复盘了在 Apollo 社区借助 Codex 推进版本验证与发布流程自动化的实践，包括 UI 端到端测试、LDAP/OIDC 集成测试、Docker/Helm 冒烟测试以及三套 Release Skill 的沉淀。实践将一次发版从约 2 天压缩到 1 小时以内，并进一步讨论了 AI Coding 对个人能力边界、开源协作方式和社区“自动驾驶”未来的影响。
categories:
---
# 缘起
...
有了这套自动化流程，Apollo 后续的版本发布时长将缩短到 1 小时以内，相比以往 2 个整天的投入，**效率提升了至少 10 倍**。
...
3. **实操层面的经验**：
    ...
    - 构建测试验证集和错误输出，让 AI 知道自己做得对不对（当然，测试集本身也可以让 AI 来构建）。
